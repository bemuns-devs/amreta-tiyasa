...
function wp_bemuns_scripts() {
	...
	if (is_front_page()) {
		wp_enqueue_script( 'particle-js', get_template_directory_uri() . '/js/particles.min.js', array(), null, true);
		
		wp_enqueue_script( 'imagesLoaded', get_template_directory_uri() . '/js/imagesloaded.pkgd.min.js', array(),
		null, true);

		wp_enqueue_script( 'masonry', get_template_directory_uri() . '/js/masonry.pkgd.min.js', array(),
		null, true);

		wp_enqueue_script( 'front-page-js', get_template_directory_uri().'/js/front-page.js', array(),
		_S_VERSION, true);
	} else {
		wp_enqueue_script( 'pages-js', get_template_directory_uri().'/js/pages.js', array(),
		_S_VERSION, true);
	}
